...
const RoomsLinks = () => {
  ...
  return (
    <>
      ...
      <div className="mb-2 font-serif not-italic font-normal leading-4 flex justify-between mt-0 pt-0 col-start-5 col-end-9 md:mb-3b md:pt-0 lg:mb-4d sm2:hidden">
      ...
      <div className="hidden sm2:text-22_green sm2:flex sm2:font-serif sm2:not-italic sm2:font-normal sm2:text-t28 sm2:leading-8 sm2:mb-4 sm2:mt-4 sm2:col-start-4 sm2:col-end-10 sm2:justify-between sm3:text-base2">
