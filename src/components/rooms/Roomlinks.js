...
const RoomsLinks = () => {
  ...
  return (
    <>
      <div className="col-start-5 col-end-9 mb-1 font-serif not-italic font-normal flex justify-between md:mb-3b md:mt-3b lg:mb-3 lg:mt-0">
      ...
      <div className="col-start-5 col-end-9 mb-2 font-serif not-italic font-normal leading-4 flex justify-between mt-0 pt-0 md:mb-3b md:pt-0 lg:mb-8">
