...
const RoomsLinks = () => {
  ...
  return (
    <>
      <div className="mb-1 font-serif not-italic font-normal flex justify-between col-start-5 col-end-9 md:mb-3b md:mt-3b lg:mb-3 lg:mt-0 sm2:flex sm2:col-start-4 sm2:col-end-7 sm2:justify-around">
      ...
      <div className="mb-2 font-serif not-italic font-normal leading-4 flex justify-between mt-0 pt-0 col-start-5 col-end-9 md:mb-3b md:pt-0 lg:mb-8 sm2:flex sm2:col-start-7 sm2:col-end-10 sm2:justify-around">
