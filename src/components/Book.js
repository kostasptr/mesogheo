...
const Book = () => {
	return (
		<div className="grid grid-cols-12 mx-1 gap-x-2 mb-4 md:mb-6a lg:mb-62 lg:mx-4c lg:gap-x-4 sm2:gap-x-1 sm2:mx-10 sm2:px-0 sm2:mb-60 sm3:gap-x-8 sm3:mx-16 sm3:mb-64">
