...
const Book = () => {
	return (
		<div className="grid grid-cols-12 px-1 gap-x-2 mb-5 md:mb-6a lg:mb-62 lg:mx-4c lg:gap-x-4">
			<div className="col-start-2 col-end-12 font-sans not-italic leading-4 text-left font-light text-small12 text-02_green tracking-normal md:text-xl md:leading-7 lg:text-2xl lg:leading-8">
				...
				<p className="mb-4 md:mb-8 lg:mb-5c">*Check in from 15.00 to 20.00<br></br>*Check out until 12.00</p>
				<p className="text-center italic ">for more information visit our FAQ page</p>
			</div>
		</div>
	);
}
