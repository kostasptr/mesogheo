  ...
  return (
    <>
      ...
      <div className="grid grid-cols-12 gap-x-2 px-1">
        <div className="col-start-2 col-end-12 mb-4 font-sans text-small12 not-italic font-light leading-4 text-left text-02_green">
      ...
      <div className="grid grid-cols-12 gap-x-2 px-1">
        ...
        <p className="col-start-2 col-end-12 mb-5 font-sans text-small12 not-italic font-light text-left text-02_green leading-4">
