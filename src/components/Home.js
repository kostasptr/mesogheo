...
const Home = () => {
  ...
  return (
    <>
      <img src={mesogheoPool} alt="mesogheo hotel" className="col-span-full w-screen mb-2 lg:mb-0"/>

      <div className="grid grid-cols-12 gap-x-2 px-1 md:mx-7 md:px-0 lg:mx-4c lg:gap-x-4 lg:mt-0 lg:mb-0">
        <div className="col-start-2 col-end-12 mb-4 font-sans text-small12 not-italic font-light leading-4 text-left text-02_green md:text-lg md:leading-7 md:mt-3b md:mb-5b lg:text-2xl lg:leading-8 lg:mt-5 lg:mb-5d">
      ...
      <div className="grid grid-cols-12 gap-x-2 px-1 md:mx-7 md:px-0 lg:mx-4c lg:gap-x-4">
        ...
        <p className="col-start-2 col-end-12 mb-5 font-sans text-small12 not-italic font-light text-left text-02_green leading-4 md:text-lg md:leading-7  md:mb-5b lg:text-2xl lg:leading-8 lg:mb-62">
