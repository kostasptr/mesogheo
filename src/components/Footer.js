...
const Footer = () => {
  ...
  return (
    <footer className="flex-shrink-0 grid grid-cols-12 px-1 gap-x-2 bg-22_green flex-column items-center md:px-7 md:gap-x-2">
      <div className="col-start-2 col-end-12 font-serif text-small font-normal not-italic leading-4 tracking-normal text-center text-92_green pt-4 pb-2 md:col-start-3 md:col-end-11 md:text-lg md:leading-6 md:pt-6 md:pb-4b">
        <p>
      ...
      <div className="col-start-6 col-end-8 flex flex-row justify-between pb-3a md:pb-5b">
        <a href="https://www.instagram.com/mesogheo/" target="_blank" rel="noopener noreferrer" className={`w-3a md:w-5 ${inTextColor}`} onMouseEnter={inToggleHover} onMouseLeave={inToggleHover}>
          <InstagramIcon />
        </a>
        <a href="https://www.facebook.com/Mesogheo" target="_blank" rel="noopener noreferrer" className={`w-3a md:w-5 ${fbTextColor}`} onMouseEnter={fbToggleHover} onMouseLeave={fbToggleHover}>
          <FacebookIcon />
        </a>
      </div>
    </footer>
