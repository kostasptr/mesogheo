  ...
  return (
    ...
    {/* sm2:flex sm2:flex-row sm2:justify-between */}
      ...
      <div className="sm2:order-2">
        ...
        <div className="sm2:order-1"> 
        <Link to="/faq" className="hover:text-pink">FAQ</Link>  
        </div>
      </div>

      <div className="col-start-6 col-end-8 flex flex-row justify-between mb-3a md:mb-5b lg:mb-5e sm2:mb-0 sm2:col-start-12 sm2:col-end-13">
