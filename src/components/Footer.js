...
const Footer = () => {
  ...
  return (
    <footer className="flex-shrink-0 grid grid-cols-12 px-1 gap-x-2 bg-22_green flex-column items-center md:px-7 md:gap-x-2 lg:px-4c lg:gap-x-4">
      <div className="col-start-2 col-end-12 font-serif text-small font-normal not-italic leading-4 tracking-normal text-center text-92_green pt-4 pb-2 md:col-start-3 md:col-end-11 md:text-lg md:leading-6 md:pt-6 md:pb-4b lg:text-xl lg:pt-0 lg:pb-0 lg:mt-60 lg:mb-5b2 lg:leading-height28">
        <p>
      ...
      <div className="col-start-6 col-end-8 flex flex-row justify-between mb-3a md:mb-5b lg:mb-5e">
