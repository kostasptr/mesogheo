...
const About = () => {
  ...
  return (
    <div className="mesogheo-grid">
			<div className="col-start-2 col-end-12 lg:col-start-3 lg:col-end-11 2lg:col-start-1 2lg:col-end-8 font-sans not-italic leading-4 text-left text-small12 tracking-normal md:text-xl md:leading-7 lg:leading-8 sm2:text-f24 sm2:leading-8 sm2:tracking-normal sm3:leading-height36">
