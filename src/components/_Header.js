  ...
  return (
    <header className="bg-92_green mt-4 mb-2 md:mb-3 sm2:mb-3 sm3:mb-2">
      <nav className="mesogheo-grid md:px-0 sm3:justify-items-stretch">
        ...
        <div className="hidden 2lg:flex 2lg:flex-col 2lg:col-start-8 sm2:col-start-8 sm3:col-start-9 2lg:col-end-13 2lg:justify-center 2lg:items-end text-22_green font-serif font-normal text-center text-base sm2:text-lg sm3:text-small22 leading-height28 sm3:leading-8">
