...
const Header = () => {
  ...
  return (
    <header className="bg-92_green mt-4 md:mt-4.5 lg:mt-9 2lg:mt-4d sm3:mt-4 mb-2 md:mb-3a lg:mb-4b 2lg:mb-3b sm2:mb-3 sm3:mb-2">
      <nav className="mesogheo-grid md:px-0 sm3:justify-items-stretch">
        
        <div className={`col-start-4 col-end-10 md:col-start-5 md:col-end-9 2lg:col-start-1 2lg:col-end-5 sm2:col-start-1 sm2:col-end-4 w-full mb-3b md:mb-4b lg:mb-4d sm2:mb-5b sm3:mb-67 sm2:pl-0 sm2:pr-5dd ${textColor}`} onMouseEnter={toggleHover} onMouseLeave={toggleHover} onTouchEnd={touch}>
          <Link ref={linkRef} to='/'>
            <ReactLogo />
          </Link>
        </div>

        <div className="hidden 2lg:flex 2lg:flex-col 2lg:col-start-8 2lg:col-end-13 sm2:col-start-8 sm2:col-end-13 2lg:mt-4d sm3:mt-75 text-22_green font-serif font-normal text-center text-base sm2:text-xl sm3:text-small22 leading-height28 sm3:leading-8">
        ...
        <div className="col-start-3 col-end-11 md:col-start-4 md:col-end-10 2lg:col-start-1 2lg:col-end-6 flex justify-between font-serif not-italic font-normal text-center text-base md:text-2xl lg:text-t28 sm2:text-base2 sm3:text-f36 tracking-normal leading-5 md:leading-9 lg:leading-height36 sm2:leading-height41 sm3:leading-height46">
