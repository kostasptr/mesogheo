  ...
  return (
    <header className="bg-92_green mt-4 mb-2 md:mb-3 lg:mb-3a 2lg:mb-3 sm2:mb-3 sm3:mb-2">
      <nav className="mesogheo-grid md:px-0 sm3:justify-items-stretch">
        ...
        <div className="hidden 2lg:flex 2lg:flex-col 2lg:col-start-8 sm2:col-start-8 sm3:col-start-9 2lg:col-end-13 2lg:justify-center 2lg:items-end text-22_green font-serif font-normal text-center text-base sm2:text-xl sm3:text-small22 leading-height28 sm3:leading-8">
        ...
        <div className="col-start-3 col-end-11 md:col-start-4 md:col-end-10 2lg:col-start-1 2lg:col-end-5 flex justify-between font-serif not-italic font-normal text-center text-base md:text-2xl lg:text-t28 2lg:text-f26 sm2:text-base2 sm3:text-f36 tracking-normal leading-5 lg:leading-height36 sm2:leading-height41 sm3:leading-height46">
